...
namespace Fuzzy_lib
{
	namespace Filter
	{
		...
		{
		public:
			using bitmap = Fuzzy_Lib::Data_types::large_bitset;
		private:
			bitmap _bitset;
			int _hash_count;
		...
		public:
			...
			virtual void add(const Data_types::bytes_view& key) override;
			virtual bool is_present(const Data_types::bytes_view& key) override;
